  ...
  <body>
        ...
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                <a class="btn btn-success" href="#">INGRESAR</a>
                </li>
            </ul>
            </div>
        </div>
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/img/img_index/imagen11e.jpg" alt="Segundo slide">
            ...
            <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/img_index/imagen10e.jpg" alt="Tercero slide">
                <div class="carousel-caption d-none d-md-block">
                    <h5>PRUEBA UN DIA GRATIS</h5>
                    <p>ACCEDE A NUESTROS ENEFICIOS</p>
                </div>
            </div>
            <div class="carousel-item ">
                <img class="d-block w-100" src="assets/img/img_index/imagen3e.jpg" alt="Cuarto slide">
                <div class="carousel-caption d-none d-md-block ">
                    <h5>Y SI</h5>
                    <h5>NO TE</h5>
                    <h5>RINDES?</h5>
